"""
Django settings for fair_46929 project.
...
WSGI_APPLICATION = 'fair_46929.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fair_46929 API",
    "DESCRIPTION": "API documentation for fair_46929 App",
    "VERSION": "v1",
}
